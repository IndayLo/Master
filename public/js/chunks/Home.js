...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    var _this = this;
    axios.get("".concat(this.$url, "/api/companies")).then(function (res) {
      _this.company_list = res.data;
    })["catch"](function (_ref) {
      var response = _ref.response;
      _this.$router.push("/error/".concat(response.status));
    });
  },
  methods: {
    ...
    insert: function insert() {
      var _this2 = this;
      axios.post("".concat(this.$url, "/api/companies"), this.company_obj).then(function (res) {
        _this2.company_list = res.data;
        _this2.company_dialog = false;
        _this2.clear_obj();
      });
    },
    save: function save() {
      var _this3 = this;
      axios.put("".concat(this.$url, "/api/companies/update"), this.company_obj).then(function (res) {
        _this3.company_list = res.data;
        _this3.company_dialog = false;
        _this3.clear_obj();
      });
    },
    delete_restore: function delete_restore(item) {
      var _this4 = this;
      axios.put("".concat(this.$url, "/api/companies/delete_restore"), item).then(function (res) {
        _this4.company_list = res.data;
        _this4.company_dialog = false;
      });
    },
    clear_obj: function clear_obj() {
      this.company_obj.company_code = '';
      this.company_obj.company_name = '';
      this.company_obj.deleted_at = '';
    },
    loginAccountDialogClose: function loginAccountDialogClose() {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\ntable[data-v-f2b6376c], tr[data-v-f2b6376c], th[data-v-f2b6376c], td[data-v-f2b6376c]{\n    border: 1px solid black;\n    border-collapse: collapse;\n}\n", ""]);
// Exports
...
var render = function () {
  ...
  return _c(
    "v-card",
    [
      _c("v-card-title", { staticStyle: { "background-color": "#B2DFDB" } }, [
        _vm._v("Compassssny"),
      ]),
      _vm._v(" "),
      _c(
        ...
        [
          _c("v-simple-table", [
            ...
            _c(
              "tbody",
              _vm._l(_vm.company_list, function (item, i) {
                return _c("tr", { key: i }, [
                    ...
                    [
                      ...
                      _c(
                        "v-btn",
                        {
                          attrs: {
                            color:
                              item.deleted_at == null ? "#F44336" : "#FFC107",
                          },
                          on: {
                            click: function ($event) {
                              return _vm.delete_restore(item)
                            },
                          },
                        },
                        [
                  ...
                  _c(
                    ...
                    {
                      style:
                        item.deleted_at == null ? "color:Green" : "color:Red",
                    },
                    [
                      _vm._v(
                        "\n                        " +
          ...
          _c(
            "v-btn",
            {
              ...
              on: {
                click: function ($event) {
                  ;(_vm.dialog_title = "Add"), (_vm.company_dialog = true)
                },
              },
            },
            [_c("v-icon", [_vm._v("+")])],
      ...
      _c(
        "v-dialog",
        {
          ...
          model: {
            value: _vm.company_dialog,
            callback: function ($$v) {
              _vm.company_dialog = $$v
            },
            expression: "company_dialog",
          },
        },
        [
          _c(
              ...
              _c(
                ...
                [
                  _c("h2", { staticStyle: { color: "white" } }, [
                    _vm._v(_vm._s(_vm.dialog_title) + " Company"),
                  ]),
                  _vm._v(" "),
                  _c("v-spacer"),
                  _vm._v(" "),
                  _c(
                    "v-icon",
                    {
                      ...
                      on: {
                        click: function ($event) {
                          ;(_vm.company_dialog = false), _vm.clear_obj()
                        },
                      },
                    },
                    [_vm._v("mdi-close")]
                      ...
                      _c(
                        ...
                        [
                          _c("v-text-field", {
                            ...
                            model: {
                              value: _vm.company_obj.company_name,
                              callback: function ($$v) {
                                _vm.$set(_vm.company_obj, "company_name", $$v)
                              },
                              expression: "company_obj.company_name",
                            },
                          }),
                        ],
                        1
